...
public class OnlineOneActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_online_one2);
        ...
        TextView textView3 = (TextView)findViewById(R.id.text12);
        TextView date = (TextView)findViewById(R.id.date6);
        TextView time = (TextView)findViewById(R.id.time6);
        Button button = (Button)findViewById(R.id.contact6);
