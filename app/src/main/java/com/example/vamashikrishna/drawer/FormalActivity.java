...
public class FormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_formal2);


        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        TextView textView = (TextView)findViewById(R.id.textView33);
        TextView textView1 = (TextView)findViewById(R.id.textView34);
        TextView textView2 = (TextView)findViewById(R.id.text13);
        TextView date = (TextView)findViewById(R.id.date7);
        TextView time = (TextView)findViewById(R.id.time7);
        TextView textView3 = (TextView)findViewById(R.id.text14);
        Button button = (Button)findViewById(R.id.contact7);
